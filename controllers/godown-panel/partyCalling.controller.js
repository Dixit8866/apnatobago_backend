 ...
 * @route   GET /api/godown-panel/party-calling/daily
...
export const getDailyCallings = async (req, res, next) => {
    try {
        ...
        return sendSuccessResponse(res, HTTP_STATUS.OK, 'Daily callings fetched', {
            data: paginatedRows,
            totalRecords,
            totalPages,
            currentPage,
...
/**
 * @desc    Get inactive parties for this godown
 * @route   GET /api/godown-panel/party-calling/inactive
 * @access  Private (GodownStaff)
 */
export const getInactiveParties = async (req, res, next) => {
    try {
        ...
        return sendSuccessResponse(res, HTTP_STATUS.OK, 'Inactive parties fetched', {
            data: paginatedRows,
            totalRecords,
            totalPages,
            currentPage,
...
/**
 * @desc    Log or update call status for a customer
 * @route   POST /api/godown-panel/party-calling/log
 * @access  Private (GodownStaff)
 */
