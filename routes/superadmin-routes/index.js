...
import orderBlockRoutes from './orderBlock.routes.js';
...
import outletOrderRoutes from './outlet-order.routes.js';
import reportRoutes from './report.routes.js';
import routeCategoryRoutes from './routeCategory.routes.js';
import routeSectionRoutes from './routeSection.routes.js';
...
router.use('/order-block', orderBlockRoutes);
...
router.use('/outlet-orders', outletOrderRoutes);
router.use('/reports', reportRoutes);
router.use('/route-categories', routeCategoryRoutes);
router.use('/route-sections', routeSectionRoutes);
